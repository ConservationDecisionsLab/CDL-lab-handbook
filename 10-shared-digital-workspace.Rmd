...
The [Conservation Decisions Lab Dropbox](https://www.dropbox.com/home/Conservation%20Decisions%20Lab?di=left_nav_browse) is currently used for storing lab documents (*e.g.*, copies of publications, document templates, et cetera) and employs web shortcuts, when relevant, to direct lab members to documents hosted in other shared digital workspaces (*e.g.*, CDL Google Drive). The CDL Dropbox also contains a link to the [CDL Photo & Media Archive](https://www.dropbox.com/scl/fo/esrtf4sx8k25wtc1apf9w/AM0fsZAJNt1wrxzRcXrOBHg?rlkey=d93jaq10e3gfittc99ays6ibx&st=bbcw6beb&dl=0) which can be added as an independent folder if storage space allows or accessed as a web shortcut from the main lab Dropbox [here](https://www.dropbox.com/scl/fo/2hyfyzuxhhri89uhegx68/AJbCP4FY9QUj9cUT2qlcxkw?rlkey=26cdprwes3spbzohu8lcfw76l&st=q1q9cobf&dl=0) (see the [Lab Media](#media) section for more information). 
