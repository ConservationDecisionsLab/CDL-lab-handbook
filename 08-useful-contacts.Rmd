...
## Conservation Decisions Lab Contacts {-#CDLcontacts}

See our [Contact List](https://docs.google.com/spreadsheets/d/1quiYCbANENkMZTp_nWQXqrlF63tJQpt369xL_pI7t1U/edit?gid=1411850798#gid=1411850798), stored in our shared Google Drive, for an up-to-date contact list for lab members as well as collaborators subscribed to our CDL-EXTERNAL mailing list (see below).
...
## Forestry (Forest & Conservation Sciences Department) Contacts {-#FCScontacts}
...
#### Biodiversity Research Centre (BRC) Listserv
