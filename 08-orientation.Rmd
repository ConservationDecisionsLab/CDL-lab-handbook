...
UBC offers students, staff and faculty a number of software licenses for free, or at a discount. If you require a software that is not offered for free through UBC, please discuss with Tara to determine whether this is something that can be covered. If you are working on a lab-owned computer you may require Norm to download software applications for you as he holds administrative privileges.
...
ArcGIS Pro licenses are offered for free through UBC. Download the software from the [ArcGIS website](https://pro.arcgis.com/en/pro-app/latest/get-started/download-arcgis-pro.htm) (or ask Norm to do this for you if using a UBC-owned computer) and email <gis.forestry@ubc.ca> to request an account. 
