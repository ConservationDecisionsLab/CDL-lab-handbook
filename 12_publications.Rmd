...
In addition, lab members are asked to upload a PowerPoint version of their presentation (if appropriate/permitted) to the [Presentation PowerPoints](https://www.dropbox.com/scl/fo/o9ybzdae2yxfiu4ffvnzq/ANZdTsCJrHc7brzbzejNEKs?rlkey=26p71mwjxskkp0l980eceegb5&st=2wjsrm8e&dl=0) folder in the CDL Dropbox (stored in 07_Publications & Media > Presentations).
...
If possible, please also add a copy of the feature (*e.g.*, PDF or photo of article, webshortcut to interview, etc.) to the [Copies of CDL News & Media Features](https://www.dropbox.com/scl/fo/7dlzqa8qz67hfn0rykfmp/AAEr4vnskl7yWvgkCQrTJls?rlkey=anp95fkw6k3x22rn4gr4l66a2&st=3tiaw5pf&dl=0) folder in the CDL Dropbox (stored in 07_Publications & Media > News & Media).