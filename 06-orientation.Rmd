...
Finally, the lab room houses our lab library (shelves on the wall above Madeline & Aidan’s workspaces). Folks are welcome to borrow from this library (see inventory [here](https://www.dropbox.com/scl/fi/2xa1qbforgg6e9zwjzkff/Lab-Room-Library-Inventory.xlsx?rlkey=z7egcad3fe43illro5b8vkqya&st=mk0btcj4&dl=0)) and use the sign-out sheet on the freezer when you borrow/return a book.
